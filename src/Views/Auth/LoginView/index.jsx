...
export default function LoginView() {
  ...
  return (
    <div className="flex h-screen items-center justify-center lg:bg-gradient-to-r lg:from-cyan-400 lg:to-blue-700 sm:bg-white sm:p-4 ">
      <div className="flex flex-col gap-3 lg:bg-white lg:p-10 rounded-lg">
        <p className="lg:text-4xl sm:text-2xl font-semibold">Compensation Management System </p>
