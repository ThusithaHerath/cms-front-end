...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full h-20  text-white">
      <div className="bg-cyan-700 h-16">
        ...
        <div className="float-left flex flex-row h-full gap-8 px-5 items-center">
        <div className="self-center">
            <Link className="flex gap-2 cursor-pointer hover:text-black" to="/">
          ...
          <div className="self-center">
            <Link className="flex gap-2 cursor-pointer hover:text-black" to="/config">
              <p className="text-md font-thin ">Config</p>
            </Link>
          </div>
          <div className="self-center">
            <Link className="flex gap-2 cursor-pointer hover:text-black" to="/addEmployee">
              <p className="text-md font-thin ">Add Employees</p>
            </Link>
          </div>
          <div className="self-center">
            <Link className="flex gap-2 cursor-pointer hover:text-black" to="/salDistribution">
              <p className="text-md font-thin ">Salary Distribution</p>
            </Link>
          </div>
        </div>
      </div>
